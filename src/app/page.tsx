import { getPostTaxonomyNames, listPublishedPosts } from "@/features/posts/repository";
...
export default function HomePage() {
  const posts = listPublishedPosts(db, 20).map((post) => ({ ...post, ...getPostTaxonomyNames(db, post.id) }));
